...
import com.github.axet.bookreader2.MemoryConfig;
...
import com.github.axet.bookreader2.fragments.LibraryFragment;
import com.github.axet.bookreader2.fragments.ReaderFragment;
...
public class MainActivity extends FullscreenActivity implements NavigationView.OnNavigationItemSelectedListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_long_press) {
            MemoryConfig.bLongPressEnabled = !MemoryConfig.bLongPressEnabled;
            return true;
        }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (menu != null) {
            MenuItem item = menu.findItem(R.id.action_long_press);
            if (item != null) {
                if (MemoryConfig.bLongPressEnabled) {
                    item.setTitle(R.string.menu_long_press_enabled);
                } else {
                    item.setTitle(R.string.menu_long_press_disabled);
                }
            }
        }
